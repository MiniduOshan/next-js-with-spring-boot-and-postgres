...
import {
  CreditCard, CheckCircle2, Edit2, Save, X, Plus, Trash2,
    ...
    <div className="max-w-6xl mx-auto space-y-4">
      <div>
        <h1 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
          <CreditCard className="w-5 h-5 text-brand" /> Subscription Price Plans
        </h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Manage the membership price plans displayed on the landing page and dashboard.
        </p>
      </div>
      <div className="flex items-center gap-2 text-xs font-medium text-slate-500 dark:text-slate-400 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl px-3 py-2 w-fit">
        <AlertCircle className="w-3.5 h-3.5 text-amber-500" />
        System plan IDs are fixed — edit content and visibility only
      </div>
